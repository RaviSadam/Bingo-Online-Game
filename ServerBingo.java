...
class GUI extends JFrame implements KeyListener{
    ...
    GUI(String player,int matrix[][]){
        ...
        grid.fill=GridBagConstraints.HORIZONTAL;grid.ipadx=500;grid.ipady=40;this.add(p1,grid);
        grid.fill=GridBagConstraints.HORIZONTAL;grid.ipadx=150;grid.ipady=30;grid.gridx=0;grid.gridy=3;this.add(tf,grid);
        grid.fill=GridBagConstraints.HORIZONTAL;grid.ipadx=150;grid.ipady=30;grid.gridx=0;grid.gridy=1;p2.setLayout(new GridLayout(1,5));this.add(p2,grid);
        grid.fill=GridBagConstraints.HORIZONTAL;grid.ipadx=150;grid.ipady=300;grid.gridx=0;grid.gridy=2;p3.setLayout(new GridLayout(5,5));this.add(p3,grid);
        this.setVisible(true);this.setSize(550,650);this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//fot window
    ...
    private boolean RowsOrColSame(int a[][]){
        ...
        else if(a[0][4]==a[1][3] && a[0][4]== a[2][2] && a[0][4]==a[3][1] && a[0][4]==a[4][0] && !this.d2){this.d2=true;return true;}
        return false;
    }
